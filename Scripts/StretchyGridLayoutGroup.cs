...
namespace UnityEngine.UI
{
    ...
    public class StretchyGridLayoutGroup : LayoutGroup
    {
        ...
        public enum Constraint { Flexible = 0, FixedColumnCount = 1, FixedRowCount = 2, FixedSize = 3 }
        ...
        public override void CalculateLayoutInputHorizontal()
        {
            ...
            else if (m_Constraint == Constraint.FixedSize)
            {
                minColumns = preferredColumns = m_ConstraintCount;
            }
            else
        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            for (int i = 0; i < rectChildren.Count; i++)
            {
                ...
                float realsize2 = ((height - (spacing[1] * (actualCellCountY - 1))) / actualCellCountY);
                SetChildAlongAxis(rectChildren[i], 0, startOffset.x + (realsize + spacing[0]) * positionX, realsize);
                SetChildAlongAxis(rectChildren[i], 1, startOffset.y + (realsize2 + spacing[1]) * positionY, realsize2);
            }
        }
    }
}
